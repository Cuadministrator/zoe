...
class SwipeRow extends Component {
  ...
  onRowLongPress () {
    ...
    } else if (this.props.onRowLongPress) {
      this.props.onRowLongPress()
    } else {
      if (this.props.closeOnRowLongPress) {
        this.closeRow()
      }
    }
  }
  ...
  combinedOnLongPress = (...args) => {
    const onLongPress = this.props.children[1].props.onLongPress
    this.onRowLongPress()
    onLongPress && onLongPress(...args)
  }
  ...
  renderVisibleContent() {
    ...
    if (onPress) {
      return React.cloneElement(this.props.children[1], {
        ...
        onLongPress: this.combinedOnLongPress,
        leftActionActivated: this.state.leftActionActivated,
        rightActionActivated: this.state.rightActionActivated,
        leftActionState: this.state.leftActionState,
        rightActionState: this.state.rightActionState,
